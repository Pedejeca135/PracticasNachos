...
// how big is address space?
    ...
    Practica 0 : 
    ***************************************************/
    if(!strcmp(comando_Fifo, "-C") || !strcmp(comando_Fifo, "-F") )//Practica 4
    {
...
*/
    ...
    //Practica 0. para imprimir la tabla de paginas.Comentado para la practica4.
    //printf("\n\nTabla de paginas:\n");
    ...
    **********************************************/
    ...
    //Practica0.comentado para la practica 4.
...
AddrSpace::swapIn(int vpn)
{
    ...
    if(swp == NULL)
    {
        printf("\nswabFile no abrio haciendo swapIn\n");
        return false;
    }
    else
    {
...
AddrSpace::swapOut()
{
    ...
    else
    {
        ...
        if(pageTable[indicePagina].dirty)//la pagina esta sucia.
        {
            ...
            if(swp == NULL)
            {
                printf("\nswabFile no abrio haciendo swapOut\n");
                return false;
            }
            else
            {
