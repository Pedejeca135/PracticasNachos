...
/************************************************************************************
	Practica 5: definiciones de los metodos implementados en la practica 5 para la clase Filesystem.
**************************************************************************************/
	void Renombra(char* nombreArchivo, char* nuevoNombre);//metodo para renombrar un archivo.
